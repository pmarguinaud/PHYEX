...
IF (KRR /= 0) THEN                ! moist case
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
  PREDTH1(JI,JJ,JK)= CSTURB%XCTV*PBLL_O_E(JI,JJ,JK) * PETHETA(JI,JJ,JK) * ZWORK1(JI,JJ,JK)
  PREDR1(JI,JJ,JK) = CSTURB%XCTV*PBLL_O_E(JI,JJ,JK) * PEMOIST(JI,JJ,JK) * ZWORK2(JI,JJ,JK)
    ENDDO
 ENDDO
ENDDO
ELSE                              ! dry case
...
!
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT     
    IF (KRR /= 0) THEN
      ZWORK1 = ZW1(JI,JJ,JK)*PETHETA(JI,JJ,JK)
    ELSE
      ZWORK1 = ZW1(JI,JJ,JK)
    END IF
...
IF (HTURBDIM=='3DIM') THEN
 ...
 DO JJ=1,D%NJT 
  ...
  ELSE
    ...
    PHI3(JI,JJ,JK)= 1. -                                       &
            (PRED2TH3(JI,JJ,JK) / PREDTH1(JI,JJ,JK) + ZW2(JI,JJ,JK)) / ZW1(JI,JJ,JK)
  END IF
    ENDDO
 ENDDO
ENDDO    
...
DO JSV=1,SIZE(PSI_SV,4)
 ...
 DO JJ=1,D%NJT 
  ...
  PSI_SV(JI,JJ,JK,JSV) = ( 1.                                             &
    - (CSTURB%XCPR3+CSTURB%XCPR5) * (PRED2THS(JI,JJ,JK,JSV)/PREDS1(JI,JJ,JK,JSV)-PREDTH1(JI,JJ,JK)) &
    - (CSTURB%XCPR4+CSTURB%XCPR5) * (PRED2RS(JI,JJ,JK,JSV)/PREDS1(JI,JJ,JK,JSV)-PREDR1(JI,JJ,JK)) &
    - CSTURB%XCPR3 * PREDTH1(JI,JJ,JK) * PPHI3(JI,JJ,JK) - CSTURB%XCPR4 * PREDR1(JI,JJ,JK) * PPSI3(JI,JJ,JK)                 &
    ...
    IF (PPHI3(JI,JJ,JK)<=CSTURB%XPHI_LIM)THEN
      ...
      D_PHI3DTDZ_O_DDTDZ(JI,JJ,JK) = PPHI3(JI,JJ,JK)                       &
          * (1. - PREDTH1(JI,JJ,JK) * (3./2.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))          &
               /((1.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))*(1.+1./2.*(PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))))) &
          ...
          - (1./2.*PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK) * (1.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK)))           &
               / ((1.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))*(1.+1./2.*(PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))))
    ELSE
      D_PHI3DTDZ_O_DDTDZ(JI,JJ,JK) = PPHI3(JI,JJ,JK)
    ENDIF
  ...
  DO JI=1,D%NIT     
    ...
    D_PHI3DTDZ_O_DDTDZ(JI,JJ,JK) = PPHI3(JI,JJ,JK)             &
          * (1. - PREDTH1(JI,JJ,JK) * (3./2.+PREDTH1(JI,JJ,JK))      &
          ...
          + PRED2TH3(JI,JJ,JK) / (PREDTH1(JI,JJ,JK)*(1.+PREDTH1(JI,JJ,JK))*(1.+1./2.*PREDTH1(JI,JJ,JK))) &
          - 1./2.*PREDTH1(JI,JJ,JK) / ((1.+PREDTH1(JI,JJ,JK))*(1.+1./2.*PREDTH1(JI,JJ,JK)))
    ELSE
      D_PHI3DTDZ_O_DDTDZ(JI,JJ,JK) = PPHI3(JI,JJ,JK)
    ENDIF
     ENDDO
...
IF (HTURBDIM=='3DIM') THEN
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT     
    ...
    IF (PPHI3(JI,JJ,JK)<=CSTURB%XPHI_LIM)THEN
#endif
      D_PHI3DRDZ_O_DDRDZ(JI,JJ,JK) =          &
                PPHI3(JI,JJ,JK) * (1.-PREDR1(JI,JJ,JK)*(3./2.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK)) &
                  / ((1.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))*(1.+1./2.*(PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK)))))  &
              - PREDR1(JI,JJ,JK) * (PRED2THR3(JI,JJ,JK)+PRED2TH3(JI,JJ,JK)) / (PREDTH1(JI,JJ,JK)         &
                  * (1.+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))*(1.+1./2.*(PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))))    &
...
IF (HTURBDIM=='3DIM') THEN
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
   D_PHI3DTDZ2_O_DDTDZ(JI,JJ,JK) = PDTDZ(JI,JJ,JK) * (PPHI3(JI,JJ,JK) +  ZWORK1(JI,JJ,JK))
     ENDDO
 ENDDO
ENDDO
ELSE
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_WTH_WTH2(JI,JJ,JK) = CSTURB%XCSHF*PBLL_O_E(JI,JJ,JK)*PETHETA(JI,JJ,JK)*0.5/CSTURB%XCTD        &
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_WTH_WTH2_O_DDTDZ(JI,JJ,JK) = (  0.5*CSTURB%XCSHF*PBLL_O_E(JI,JJ,JK)*PETHETA(JI,JJ,JK)*0.5/CSTURB%XCTD/PD(JI,JJ,JK) &
                                - PM3_WTH_WTH2(JI,JJ,JK)/PD(JI,JJ,JK)*(1.5+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))  )&
...
M3_WTH_W2TH(JI,JJ,JK) = CSTURB%XCSHF*PKEFF(JI,JJ,JK)*1.5/ZWORK1(JI,JJ,JK)              &
  * (1. - 0.5*PREDR1(JI,JJ,JK)*(1.+PREDR1(JI,JJ,JK))/PD(JI,JJ,JK) ) / (1.+PREDTH1(JI,JJ,JK))
  ENDDO
 ENDDO
ENDDO
!
 ...
 * (1. - 0.5*PREDR1(JI,JJ,JK)*(1.+PREDR1(JI,JJ,JK))/PD(JI,JJ,JK)* &
   ( 1.+(1.+PREDTH1(JI,JJ,JK))*(1.5+PREDR1(JI,JJ,JK)+PREDTH1(JI,JJ,JK))/PD(JI,JJ,JK)) )
  ENDDO
 ENDDO
ENDDO
!
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_WTH_W2R(JI,JJ,JK) = - CSTURB%XCSHF*PKEFF(JI,JJ,JK)*0.75*CSTURB%XCTV*PBLL_O_E(JI,JJ,JK) &
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_WTH_W2R_O_DDTDZ(JI,JJ,JK) = - CSTURB%XCSHF*PKEFF(JI,JJ,JK)*0.75*CSTURB%XCTV*PBLL_O_E(JI,JJ,JK) &
                               /ZWORK1(JI,JJ,JK)*PEMOIST(JI,JJ,JK)/PD(JI,JJ,JK) &
                                     * (1. -  PREDTH1(JI,JJ,JK)*(1.5+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))/PD(JI,JJ,JK))
  ENDDO
 ENDDO
ENDDO
!
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_WTH_WR2(JI,JJ,JK) = - CSTURB%XCSHF*PKEFF(JI,JJ,JK)*0.25*PBLL_O_E(JI,JJ,JK)*CSTURB%XCTV*PEMOIST(JI,JJ,JK)**2       &
                           *ZWORK1(JI,JJ,JK)/CSTURB%XCTD*PDTDZ(JI,JJ,JK)/PD(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
!
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_WTH_WR2_O_DDTDZ(JI,JJ,JK) = - CSTURB%XCSHF*PKEFF(JI,JJ,JK)*0.25*PBLL_O_E(JI,JJ,JK)*CSTURB%XCTV*PEMOIST(JI,JJ,JK)**2 &
                           *ZWORK1(JI,JJ,JK)/CSTURB%XCTD/PD(JI,JJ,JK)     &
                           * (1. -  PREDTH1(JI,JJ,JK)*(1.5+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))/PD(JI,JJ,JK))
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_WTH_WTHR(JI,JJ,JK) = CSTURB%XCSHF*PKEFF(JI,JJ,JK)*PEMOIST(JI,JJ,JK)*ZWORK1(JI,JJ,JK) &
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_WTH_WTHR_O_DDTDZ(JI,JJ,JK) = - PM3_WTH_WTHR(JI,JJ,JK) * (1.5+PREDTH1(JI,JJ,JK)+PREDR1(JI,JJ,JK))&
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_TH2_W2TH(JI,JJ,JK) = - ZWORK1(JI,JJ,JK) &
...
!        / (1.+PREDTH1)**2, D%NKA, D%NKU, D%NKL)
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
  D_M3_TH2_W2TH_O_DDTDZ(JI,JJ,JK) = - 1.5*PLM(JI,JJ,JK)*PLEPS(JI,JJ,JK)/PTKE(JI,JJ,JK)*CSTURB%XCTV * &
                                 ZWORK1(JI,JJ,JK)
    ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_TH2_WTH2_O_DDTDZ(JI,JJ,JK) = PLEPS(JI,JJ,JK)*0.5/CSTURB%XCTD/PSQRT_TKE(JI,JJ,JK)*CSTURB%XCTV &
                               * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_TH2_W2R(JI,JJ,JK) = 0.75*CSTURB%XCTV**2*ZWORK1(JI,JJ,JK) &
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_TH2_W2R_O_DDTDZ(JI,JJ,JK) = 0.75*CSTURB%XCTV**2*PLM(JI,JJ,JK)*PLEPS(JI,JJ,JK)/PTKE(JI,JJ,JK) &
                              * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_TH2_WR2(JI,JJ,JK) = 0.25*CSTURB%XCTV**2*ZWORK1(JI,JJ,JK)&
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_TH2_WR2_O_DDTDZ(JI,JJ,JK) = 0.25*CSTURB%XCTV**2*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD &
                              *  ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_TH2_WTHR(JI,JJ,JK) = - 0.5*CSTURB%XCTV*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD &
                       *ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_TH2_WTHR_O_DDTDZ(JI,JJ,JK) = - 0.5*CSTURB%XCTV*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD &
                               * ZWORK1(JI,JJ,JK) 
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_THR_WTHR_O_DDTDZ(JI,JJ,JK) = 0.5*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD * CSTURB%XCTV &
                               * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_THR_WTH2(JI,JJ,JK) = - 0.25*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD*CSTURB%XCTV &
                     * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_THR_WTH2_O_DDTDZ(JI,JJ,JK) = - 0.25*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD*CSTURB%XCTV**2 &
                               * ZWORK1(JI,JJ,JK) 
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_THR_WTH2_O_DDRDZ(JI,JJ,JK) = - 0.25*PLEPS(JI,JJ,JK)/PSQRT_TKE(JI,JJ,JK)/CSTURB%XCTD*CSTURB%XCTV          &
                               * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
M3_THR_W2TH(JI,JJ,JK) = - 0.75*PLM(JI,JJ,JK)*PLEPS(JI,JJ,JK)/PTKE(JI,JJ,JK) * CSTURB%XCTV      &
                     * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_THR_W2TH_O_DDTDZ(JI,JJ,JK) = - 0.75*PLM(JI,JJ,JK)*PLEPS(JI,JJ,JK)/PTKE(JI,JJ,JK) * CSTURB%XCTV**2    &
                               * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
D_M3_THR_W2TH_O_DDRDZ(JI,JJ,JK) = - 0.75*PLM(JI,JJ,JK)*PLEPS(JI,JJ,JK)/PTKE(JI,JJ,JK) * CSTURB%XCTV     &
                               * ZWORK1(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
