...
DO JK=1,D%NKT 
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
ZKEFF(JI,JJ,JK) = PLM(JI,JJ,JK) * SQRT(PTKEM(JI,JJ,JK)) + 50*MFMOIST(JI,JJ,JK)
  ENDDO
 ENDDO
ENDDO
ELSE
...
IF (OHARAT) THEN
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
  ZF(JI,JJ,JK) = PLMF(JI,JJ,JK)*PLEPSF(JI,JJ,JK)*ZWORK1(JI,JJ,JK)
    ENDDO
 ENDDO
ENDDO
ELSE
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
  ZF(JI,JJ,JK) = CSTURB%XCTV*PLM(JI,JJ,JK)*PLEPS(JI,JJ,JK)*ZWORK1(JI,JJ,JK)
    ENDDO
 ENDDO
ENDDO
ENDIF
...
ENDDO
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
      ...
      ZDFDDTDZ = ZDFDDTDZ + ZWORK2(JI,JJ,JK) * PFR2(JI,JJ,JK)
        ENDDO
 ENDDO
ENDDO
    END IF
...
ENDDO
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
  ZFLXZ(JI,JJ,JK)   = ZF(JI,JJ,JK) + PIMPL * ZDFDDTDZ(JI,JJ,JK) * ZWORK1(JI,JJ,JK)
    ENDDO
 ENDDO
ENDDO
  !
  ...
  DO JI=1,D%NIT 
      ZFLXZ(JI,JJ,JK)   = ZF(JI,JJ,JK)                                           &
        + PIMPL * PLMF(JI,JJ,JK)*PLEPSF(JI,JJ,JK)*0.5                          &
          * ZWORK3(JI,JJ,JK)                                                &
        + PIMPL * ZDFDDTDZ(JI,JJ,JK) * ZWORK1(JI,JJ,JK)         &
        + PIMPL * ZDFDDRDZ(JI,JJ,JK) * ZWORK2(JI,JJ,JK)
         ENDDO
 ENDDO
ENDDO
    ELSE
...
ENDDO
 ...
 DO JJ=1,D%NJT 
  DO JI=1,D%NIT 
      PSIGS(JI,JJ,JK) = PSIGS(JI,JJ,JK) + PAMOIST(JI,JJ,JK) **2 * ZFLXZ(JI,JJ,JK)
        ENDDO
 ENDDO
ENDDO
    END IF
